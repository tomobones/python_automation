...
#anlage(0, 1.06, 7, 25)
anlage(15000, 1.08, 25, 200)

"""
todo
- wenn die anlagen so weiterlaufen: wie viel kann ich dann pro monat abbuchen um nach 'rentenjahre' auf Null zu kommen?
- rentenlücke mit inflation berechnen, verschiedene szenarien
- schaubilder berechnen
"""

#rentenjahre = 35
#print(f"rentenjahre: {rentenjahre}, pro Monat {}")
